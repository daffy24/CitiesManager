...
const API_BASE_URL: string = "http://localhost:5284/api/";
...
export class CitiesService {
  ...
  public putCity(city: City): Observable<string> {
    ...
    return this.httpClient.put<string>(`${API_BASE_URL}cities/${city.cityID}`, city, { headers: headers })
  }
  ...
  public deleteCity(cityID: string | null): Observable<string> {
    ...
    return this.httpClient.delete<string>(`${API_BASE_URL}cities/${cityID}`, { headers: headers })
  }
}
